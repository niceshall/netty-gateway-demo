...
public class QueuingDecoderChunked extends ChunkedMessageToMessageDecoder<Object> {

    private final static Logger logger = LoggerFactory.getLogger(QueuingDecoderChunked.class);
    ...
    public QueuingDecoderChunked(EventLoopGroup clientGroup, HttpObjectAggregator httpObjectAggregator) {
...
//            }
    ...
    private Boolean handleHttpRequest(ChannelHandlerContext ctx, Object msg) throws URISyntaxException, InterruptedException {
        if (msg instanceof HttpRequest) {
            ...
            ChannelUtils.getExistOrNewOutboundChannel(ctx, host, port, clientGroup, keepAlive);
